                        ...
                        <div className="row">
                            ...
                            <div className="row no-gutters">
                                {this.state.data.albums.map(album => (
                                    ...
                                    <div className="col-xs-6 col-sm-3" key={album.id} onClick={(e) => this.onClick(e, album.id)} onMouseEnter={this.onHover} onMouseLeave={this.onOut} style={{ height: 200 + "px", backgroundSize: "cover", backgroundPosition: "center", backgroundImage: `url(http://musicmanager.hopto.org:90/images/${album.external_id}.jpg)` }}>
